...
- [インストール](/ja/docs/installation) — ソースからVをビルドするかバイナリをダウンロード。
- [Hello World](/ja/docs/hello-world) — 最初のVプログラム。
- [変数](/ja/docs/basics/variables) — 変数の宣言と使用方法。
- [関数](/ja/docs/basics/functions) — 関数の定義と呼び出し。
