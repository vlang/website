...
- [Kurulum](/tr/docs/installation) — V'yi kaynaktan derleyin veya ikilileri indirin.
- [Merhaba Dünya](/tr/docs/hello-world) — İlk V programınız.
- [Değişkenler](/tr/docs/basics/variables) — Değişkenleri nasıl tanımlayıp kullanacağınız.
- [Fonksiyonlar](/tr/docs/basics/functions) — Fonksiyon tanımlama ve çağırma.
