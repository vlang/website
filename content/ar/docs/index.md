...
- [التثبيت](/ar/docs/installation) — بناء V من المصدر أو تنزيل الملفات الثنائية.
- [مرحبًا بالعالم](/ar/docs/hello-world) — برنامجك الأول بلغة V.
- [المتغيرات](/ar/docs/basics/variables) — كيفية إعلان المتغيرات واستخدامها.
- [الدوال](/ar/docs/basics/functions) — تعريف الدوال واستدعاؤها.
